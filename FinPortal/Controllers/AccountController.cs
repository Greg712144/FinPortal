...
namespace FinPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(UserInfoViewModel.LoginMod model, string returnUrl)
        {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(UserInfoViewModel.RegisterMod model, HttpPostedFileBase image)
        {
            if (ModelState.IsValid)
            {
